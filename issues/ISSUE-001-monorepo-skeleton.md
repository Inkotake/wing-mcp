# ISSUE-001-monorepo-skeleton: Monorepo Skeleton

## Goal

Create the ai-sound-engineer monorepo with TypeScript, Rust workspace, lint/test/build scripts, docs, and agent presets.
